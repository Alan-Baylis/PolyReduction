...
namespace PolyReduction
{
    ...
    {
        private const int RABBIT_VERTEX_NUM = 453;
        private const int RABBIT_TRIANGLE_NUM = 902;
        //private const int RABBIT_VERTEX_NUM = 24;
        //private const int RABBIT_TRIANGLE_NUM = 12;
        //private const int RABBIT_VERTEX_NUM = 4;
        //private const int RABBIT_TRIANGLE_NUM = 4;

//        public static float[,] rabbit_vertices = {
//		{ 0,0,0 },
//		{ 1,0,0 },
//		{ 1,0,1 },
//		{ 0,0,1 },
...
//        public static int[,] rabbit_triangles = {
//	{ 0,1,3 },
//	{ 1,2,3 },
//	{ 4,5,7 },
//	{ 5,6,7 },
